...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <header class="entry-header" <?php if (get_field('intro_section_color')) {echo 'style="background-color: ' . get_field('intro_section_color') .'"'; } ?>>
	...
	<div class="entry-content">
		<?php
            ...
            $messages = get_posts($messageArgs);
