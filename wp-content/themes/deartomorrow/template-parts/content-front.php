...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        ?>
                            <li class="lightslide">
                                <div class="slider-image">
                                    <a href="<?php echo get_permalink($slide->ID); ?>"><?php echo get_the_post_thumbnail( $slide->ID, 'slider-thumb' ); ?></a>
                                </div>
    ...
    ?>
        ...
        <div id="instagramDearTomorrow" class="section instagram">
            <h1>instagram</h1>
            <?php echo do_shortcode('[instagram feed="30310"]'); ?>
        </div>
