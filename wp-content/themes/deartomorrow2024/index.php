...
<div class="place-content-center flex items-center h-full max-w-screen-lg mx-auto">
    <div class="text-center">
        <h1 class="text-4xl font-bold text-midnight-blue">Hello World!</h1>
        <h2 class="text-xl font-bold text-midnight-blue">Wordpress Theme rapid development using Vite & Tailwindcss</h2>
